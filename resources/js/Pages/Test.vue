                        ...
                        <table class="min-w-full text-left text-sm font-light">
                          ...
                          >
                            <tr>
                              ...
                              <th scope="col" class="px-6 py-4">SaTy</th>
                              <th scope="col" class="px-6 py-4">ItCa</th>
                              <th scope="col" class="px-6 py-4">Sales Doc.</th>
                            </tr>
                          </thead>
                          <tbody>
                            <tr
...
const submit = () => {
  const startDate = new Date();
  const endDate = new Date(new Date().setDate(startDate.getDate() + 7));
  console.log((date.value = [startDate, endDate]));
